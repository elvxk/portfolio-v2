...
import ps1 from "../assets/img/portfolio/pesenstudio/ps1.webp";
import ps2 from "../assets/img/portfolio/pesenstudio/ps2.webp";
import ps3 from "../assets/img/portfolio/pesenstudio/ps3.webp";

const PesenstudioModal = () => {
  return (
    <div
      id="pesenstudio-modal"
      tabindex="-1"
      aria-hidden="true"
        ...
        <div className="relative bgMain rounded-lg shadow">
          <div className="flex flex-col justify-between px-4 pt-4 rounded-t">
            <div className="flex items-center justify-between py-4 rounded-t">
              <h1 className="font-Bold fbold text-4xl">PESEN STUDIO MLG</h1>
              <button
                type="button"
                ...
                data-modal-hide="pesenstudio-modal"
              >
                <svg
                  className="w-3 h-3"
                  aria-hidden="true"
...
export default PesenstudioModal;
