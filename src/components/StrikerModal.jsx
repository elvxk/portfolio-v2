...
import ps1 from "../assets/img/portfolio/stxrp/stxrp1.webp";
import ps2 from "../assets/img/portfolio/stxrp/stxrp2.webp";
import ps3 from "../assets/img/portfolio/stxrp/stxrp3.webp";
        ...
        <div className="relative bgMain rounded-lg shadow">
          <div className="flex flex-col justify-between px-4 pt-4 rounded-t">
            <div className="flex items-center justify-between py-4 rounded-t">
              <h1 className="font-Bold fbold text-4xl">STRIKER SIX ROLEPLAY</h1>
              <button
                type="button"
